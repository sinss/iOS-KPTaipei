...
+ (void)initialize
{
    if (self == [BlockAlertView class])
    {
        ...
        backgroundlandscape = [UIImage imageNamed:kActionSheetBackground];
...
- (void)addComponents:(CGRect)frame {
    if (_title)
    {
        CGSize size = [_title boundingRectWithSize:CGSizeMake(frame.size.width-kAlertViewBorder*2, 1000) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:titleFont} context:nil].size;
...
//                           constrainedToSize:CGSizeMake(frame.size.width-kAlertViewBorder*2, 1000)
//                               lineBreakMode:NSLineBreakByWordWrapping];
        CGSize size = [_message boundingRectWithSize:CGSizeMake(frame.size.width-kAlertViewBorder*2, 1000) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:titleFont} context:nil].size;
...
//                                lineBreakMode:NSLineBreakByClipping];
            CGSize size = [_title boundingRectWithSize:CGSizeMake(_view.frame.size.width-kAlertViewBorder*2, 1000) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:buttonFont} context:nil].size;
...
//                                   forWidth:_view.bounds.size.width-kAlertViewBorder*2 
//                              lineBreakMode:NSLineBreakByClipping];
                size = [title2 boundingRectWithSize:CGSizeMake(_view.bounds.size.width-kAlertViewBorder*2, 1000) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:buttonFont} context:nil].size;
...
//                                     forWidth:_view.bounds.size.width-kAlertViewBorder*2
//                                lineBreakMode:NSLineBreakByClipping];
            CGSize size = [title boundingRectWithSize:CGSizeMake(_view.bounds.size.width-kAlertViewBorder*2, 1000) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:buttonFont} context:nil].size;
